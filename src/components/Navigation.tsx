      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <div className="hidden lg:flex items-center gap-3">
            <a
              href="/login"
              className="text-gray-300 hover:text-white px-4 py-2.5 rounded-lg font-medium transition-all duration-200 border border-slate-600 hover:border-slate-500"
            >
              PM Login
            </a>
            <button
        ...
        {isMobileMenuOpen && (
          <div className="lg:hidden border-t border-slate-700 bg-slate-900/95 backdrop-blur-md">
            <div className="px-4 py-6 space-y-4">
              ...
              <a
                href="/login"
                className="block w-full text-center text-gray-300 hover:text-white px-6 py-3 rounded-lg font-medium transition-all duration-200 border border-slate-600"
                onClick={() => setIsMobileMenuOpen(false)}
              >
                PM Login
              </a>
