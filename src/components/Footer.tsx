      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-16">
        ...
        <div className="border-t border-gray-800 pt-12 pb-8">
          <div className="max-w-md">
            ...
            <p className="text-gray-400 mb-6">Get the latest updates on FlowSight features and releases.</p>
            <div className="flex gap-3">
              <input
                type="email"
                placeholder="Enter your email"
                className="flex-1 px-4 py-3 bg-gray-800 border border-gray-700 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:border-teal-500 transition-colors"
              />
              <button className="bg-teal-500 hover:bg-teal-600 text-white px-6 py-3 rounded-lg font-medium transition-colors duration-200">
                Subscribe
              </button>
            </div>
          </div>
